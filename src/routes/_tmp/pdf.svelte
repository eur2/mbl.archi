...
<script>
  export let posts;
  import Post from "../components/PostSlide.svelte";
  // import "lazysizes";
  // console.log(posts);
</script>
...
<aside class="fixed t0 r0 z10 p">
  <a
    href="https://cyberfem-pdf-renderer.herokuapp.com/api/render?emulateScreenMedia=false&url=https://mbl.vercel.app/pdf">PDF</a>
</aside>
{#each posts as post}
  <Post
